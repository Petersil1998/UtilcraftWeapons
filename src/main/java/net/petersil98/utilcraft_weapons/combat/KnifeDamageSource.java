...
public class KnifeDamageSource extends EntityDamageSource {
    ...
    public Component getLocalizedDeathMessage(@Nonnull LivingEntity killedEntity) {
        return new TranslatableComponent(String.format("%s.kill.knife", UtilcraftWeapons.MOD_ID), killedEntity.getDisplayName().getString(), this.entity.getDisplayName().getString());
    }
}

...
public class BulletDamageSource extends EntityDamageSource {
    ...
    public ITextComponent getDeathMessage(LivingEntity entityLivingBaseIn) {
        return new TranslationTextComponent(String.format("%s.kill.sniper", UtilcraftWeapons.MOD_ID), entityLivingBaseIn.getDisplayName().getString(), damageSourceEntity.getDisplayName().getString());
    }
}

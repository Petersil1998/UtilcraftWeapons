...
public class EventHandler {
    ...
    @SubscribeEvent
    public static void onMouseClickEvent(InputEvent.MouseInputEvent event) {
    ...
    @SubscribeEvent
    public static void potionColorCalculationEvent(PotionColorCalculationEvent event) {
    ...
    public static void playerLoginEvent(PlayerEvent.PlayerLoggedInEvent event) {
        if(event.getEntity() instanceof ServerPlayerEntity) {
            ...
            player.getCapability(CapabilityStealth.STEALTH_CAPABILITY).ifPresent(iStealth -> {
                PacketHandler.sendToClients(new SyncStealthPacket(iStealth.isStealth(), player.getEntityId()), player);
            });
        }
    }

    @SubscribeEvent
    public static void attachStealthCapability(AttachCapabilitiesEvent<Entity> event) {
